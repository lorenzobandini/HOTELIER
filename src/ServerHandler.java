...
public class ServerHandler implements Runnable {
    ...
    private String homeMessage(){
        if(this.isLogged){
            return "Welcome to the Hotel Booking System HOTELIER!\nThe commands are:\n[1] register <username> <password>\n[2] login <username> <password>\n[3] logout <username>\n[4] searchHotel <hotelName> <city>\n[5] searchAllHotels <city>\n[6] insertReview <hotelName> <city> <globalScore> <scores>\n[7] showMyBadges\n[8] exit";
        }else{
            return "Welcome to the Hotel Booking System HOTELIER!\nThe commands that you can do are (for some of these you will have to login):\n[1] register <username> <password>\n[2] login <username> <password>\n[3] logout <username> (login required)\n[4] searchHotel <hotelName> <city>\n[5] searchAllHotels <city>\n[6] insertReview <hotelName> <city> <globalScore> <scores> (login required)\n[7] showMyBadges (login required)\n[8] exit";
        }
